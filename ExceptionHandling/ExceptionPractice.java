...
public class ExceptionPractice {
	public static void validate(String s) {//throws CustomException {
		try {
	...
	public static void main(String[] args) {
		...
		try {
			...
			// throw new IOException("Check it is catched!");//checked exception are
			// catched;
		} catch (Exception e) {
		...
		try {
			...
			System.out.println(e + " common task completed");
		}
		...
		System.out.println("rest of the code...");
		try {
			throw new IOException(); // IF 25/0 ,it rises Arithmatic exception and it executes finally block
		} catch (Exception e) {
			System.out.println(e);
		} finally {
		...
		int age = 15;
		if (age < 18) {
			// throw new ArithmeticException("not valid"); ///will throw a Arithmatic
		...
		/*
		 * Lets Check Exception Propagation in another class, by creating object in this
		 * class
		 */
